...
export const experiences: Experience[] = [
  {
    ...
    current: true,
    description:
      'Leading front-end development team on enterprise B2B platform "Affectli". Architecting complex features, conducting code reviews, and pioneering AI-assisted development practices.',
    achievements: [
      'Lead a team of front-end developers on enterprise-scale projects',
      'Architected Form Builder with 50+ field types and drag-and-drop functionality',
      'Built GraphQL architecture: 350+ operations with Apollo Client & WebSocket subscriptions',
      'Implemented BPMN Process Designer for visual workflow editing',
      'Integrated Bryntum Grid/Gantt for enterprise dashboards and data visualization',
      'Pioneered AI-assisted development: Mi-Comply project 95% built with Claude',
      'Write and maintain E2E automated tests with Playwright',
      'Mentor developers and conduct architectural code reviews',
    ],
    skills: ['React', 'GraphQL', 'Apollo Client', 'BPMN.js', 'Bryntum', 'WebSocket', 'Claude AI', 'Playwright', 'Team Leadership'],
  },
  {
    id: 'reservble',
    company: 'Reservble',
  ...
  },
  {
    ...
    type: 'full-time',
    description:
      'Front-end development for enterprise B2B platform "Affectli". Built foundational architecture including drag-and-drop Form Builder and complex data visualizations.',
    achievements: [
      'Built drag & drop Form Builder from scratch with extensible field architecture',
      'Developed core UI component library used across the platform',
      'Implemented real-time chat integration with Rocket.Chat API',
      'Created geospatial visualizations with OpenLayers and Cesium 3D',
      'Worked with complex data grids and chart visualizations',
    ],
    skills: ['React', 'Redux', 'Flow', 'JavaScript', 'OpenLayers', 'Cesium', 'Git', 'GitLab'],
  },
  {
    id: 'wanderbeat',
